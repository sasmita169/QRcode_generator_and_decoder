...
import binascii
import hashlib
from block3 import protect_data3
...
def protect_data2(hashcode_data):
               ...
               # print(voted_details[0:3])
                ...
                print("block 3 results are complete ", message.decode())
                print(" block 3 encrypted_data",ciphertext )


                ciphertext=protect_data3(ciphertext)
