...
import binascii
import hashlib
from block2 import protect_data2
...
def protect_data(hashcode_data):
               ...
               # print(voted_details[0:3])
                ...
                print("block 2 results are complete ", message.decode())
                print(" block 2 encrypted_data",ciphertext )



                ciphertext=protect_data2(ciphertext)
